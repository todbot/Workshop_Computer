...
//  if (voltage > maxVoltage) voltage = maxVoltage;
  ...
  if (dacValueFloat < 0.0f) dacValueFloat = 0.0f;
  if (dacValueFloat > 524287.0f) dacValueFloat = 524287.0f;

  uint32_t dacValue = (uint32_t)(dacValueFloat + 0.5f);  // Round to nearest integer
